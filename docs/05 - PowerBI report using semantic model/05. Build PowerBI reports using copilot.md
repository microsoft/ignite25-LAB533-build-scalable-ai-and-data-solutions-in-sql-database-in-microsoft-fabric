...
1. Click on the workspace and look for the newly created **semantic model - product_insight**. Select the product_insigt semantic model.
...
1. Click the **explore new data** and **Create a blank report**.
